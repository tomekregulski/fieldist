...
class CreateDemo extends Component {
  constructor(props) {
    super(props);
    this.state = { brand_id: "", date: "", campaign_id: "", venue_id: "", user_id: "", start_time: "", duration:"", brands: [], campaigns: [], venues: [], reps: [] };
          ...
          <Form.Group >
            ...
            >
              ...
              { this.state.campaigns.map( (campaign, j) => (
                <option key={j} value={campaign.id}>{campaign.name}</option>
              ))}
            </Form.Control>
          </Form.Group>
          <Form.Group >
            ...
            >
              ...
              { this.state.venues.map( (venue, j) => (
                <option key={j} value={venue.id}>{venue.name}</option>
              ))}
            </Form.Control>
          </Form.Group>
          <Form.Group >
            ...
            >
              ...
              { this.state.reps.map( (rep, j) => (
                <option key={j} value={rep.id}>{rep.first_name} {rep.last_name}</option>
              ))}
            </Form.Control>
          </Form.Group>
